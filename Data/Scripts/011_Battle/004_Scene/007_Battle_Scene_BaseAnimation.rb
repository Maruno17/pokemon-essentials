...
module Battle::Scene::Animation::BallAnimationMixin
  ...
  def ballBurst(delay, ball, ballX, ballY, poke_ball)
    ...
    if poke_ball == :MASTERBALL
      ...
      glare1.moveZoom(delay, glare_fade_duration, (["dazzle", "circle wave", "web"].include?(variances[11])) ? 100 : 250)
    end
    ...
    if poke_ball == :MASTERBALL
      ...
      glare2.moveZoom(delay, glare_fade_duration, (["dazzle", "circle wave", "web"].include?(variances[8])) ? 125 : 200)
    end
  ...
  def ballBurstCapture(delay, ball, ballX, ballY, poke_ball)
    ...
    num_particles.times do |i|
      ...
      [particle2, particle3].each_with_index do |particle, num|
        ...
        elsif ["dazzle", "circle faded", "shine 3"].include?(variances[12 - (3 * num)])
    ...
    if poke_ball == :NETBALL
      web = addNewSprite(ballX, ballY, "Graphics/Battle animations/web", PictureOrigin::CENTER)
      web.setZ(0, 5123)
      web.setZoom(0, 120)
      web.setOpacity(0, 0)
  ...
  def ballCaptureSuccess(ball, delay, ballX, ballY)
    ...
    3.times do |i|   # Left, middle, right
      # Set up particle
      star = addNewSprite(ballX, ballY, "Graphics/Battle animations/star 1", PictureOrigin::CENTER)
      star.setZ(0, 5110)
  ...
  def ballBurstRecall(delay, ball, ballX, ballY, poke_ball)
    ...
    # Ring particles
    ring1 = addNewSprite(ballX, ballY, "Graphics/Battle animations/circle 1", PictureOrigin::CENTER)
    ring1.setZ(0, 5110)
    ring1.setZoom(0, 0)
    ring1.setVisible(0, false)
    ring2 = addNewSprite(ballX, ballY, "Graphics/Battle animations/circle 2", PictureOrigin::CENTER)
    ring2.setZ(0, 5110)
