...
class Battle::AI
  ...
  BASE_ABILITY_RATINGS = {
    ...
    8  => [:ADAPTABILITY, :AERILATE, :COMMANDER, :CONTRARY, :DISGUISE,
           :DRAGONIZE, :DRAGONSMAW, :EELEVATE, :GALVANIZE, :GOODASGOLD,
           :ILLUSION, :LIBERO, :MULTISCALE, :MULTITYPE, :NOGUARD, :OPPORTUNIST,
           :POISONHEAL, :PIXILATE, :PRANKSTER, :PROTEAN, :REFRIGERATE,
           :REGENERATOR, :RKSSYSTEM, :SERENEGRACE, :SHADOWSHIELD, :SHEERFORCE,
           :SIMPLE, :SUPREMEOVERLORD, :TECHNICIAN, :TRANSISTOR, :WATERBUBBLE],
    ...
    5  => [:AFTERMATH, :AIRLOCK, :ANALYTIC, :ANGERSHELL, :BERSERK, :BLAZE,
           :CLOUDNINE, :COMPETITIVE, :CORROSION, :DANCER, :DEFIANT, :FIREMANE,
           :FLAREBOOST, :FLUFFY, :GOOEY, :HARVEST, :HEATPROOF, :INNARDSOUT,
           :LINGERINGAROMA, :LIQUIDVOICE, :MARVELSCALE, :MUMMY, :MYCELIUMMIGHT,
           :NEUTRALIZINGGAS, :OVERCOAT, :OVERGROW, :PRESSURE, :PURIFYINGSALT,
           :QUICKFEET, :ROCKHEAD, :SANDSPIT, :SEEDSOWER, :SHIELDDUST,
           :SLUSHRUSH, :SWARM, :TANGLINGHAIR, :TORRENT, :TOXICCHAIN,
           :TOXICDEBRIS, :ZEROTOHERO],
...
Battle::AI::Handlers::AbilityRanking.copy(:BLAZE, :FIREMANE)
