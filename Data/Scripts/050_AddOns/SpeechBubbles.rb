...
def pbMessageNoSound(message,commands=nil,cmdIfCancel=0,skin=nil,defaultCmd=0,&block)
  ...
  if commands
    ...
    pbMessageDisplayNoSound(msgwindow,message,&block)
  end
...
def getSkinColor(windowskin,color,isDarkSkin)
  if !windowskin || windowskin.disposed? ||
     ...
     textcolors=[
      shadowc3tag(Color.new(72,80,88), MessageConfig::BUBBLE_TEXT_SHADOW),
       "<c2=7E105D08>",
       "<c2=421F2117>",
       "<c2=43F022E8>",
       "<c2=7FF05EE8>",
    ...
    textcolors=[
      shadowc3tag(MessageConfig::BUBBLE_TEXT_BASE, MessageConfig::BUBBLE_TEXT_SHADOW),
       "<c2=7E105D08>",
       "<c2=421F2117>",
       "<c2=43F022E8>",
       "<c2=7FF05EE8>",
