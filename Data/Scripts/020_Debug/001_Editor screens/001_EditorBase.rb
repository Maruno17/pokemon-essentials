...
class Debug::EditorBase
  ...
  SCROLLBAR_THICKNESS = 16   # UIControls::Scrollbar::SLIDER_WIDTH
  ...
  GRAPHIC_CHOOSER_FILE_LIST_WIDTH  = (BIG_BUTTON_WIDTH * 2) + (2 * 2)   # UIControls::List::LIST_FRAME_THICKNESS = 2
  GRAPHIC_CHOOSER_FILE_LIST_HEIGHT = (ROW_HEIGHT * 15) + (2 * 2)   # UIControls::List::LIST_FRAME_THICKNESS = 2
  ...
  LOCATION_CHOOSER_MAP_LIST_WIDTH  = (BIG_BUTTON_WIDTH * 2) + (2 * 2) + 3   # UIControls::List::LIST_FRAME_THICKNESS = 2
  LOCATION_CHOOSER_MAP_LIST_HEIGHT = (ROW_HEIGHT * 20) + (2 * 2)   # UIControls::List::LIST_FRAME_THICKNESS = 2
