  ...
  class MapMetadata
    ...
    def self.editor_properties
      return [
         ...
         ["HealingSpot",      MapCoordsProperty,                  _INTL("Map ID of this Pokemon Center's town, and X and Y coordinates of its entrance within that town.")],
         ...
         ["WildBattleBGM",    BGMProperty,                        _INTL("Default BGM for wild Pokemon battles on this map.")],
         ["TrainerBattleBGM", BGMProperty,                        _INTL("Default BGM for trainer battles on this map.")],
         ["WildVictoryME",    MEProperty,                         _INTL("Default ME played after winning a wild Pokemon battle on this map.")],
         ["TrainerVictoryME", MEProperty,                         _INTL("Default ME played after winning a Trainer battle on this map.")],
         ["WildCaptureME",    MEProperty,                         _INTL("Default ME played after catching a wild Pokemon on this map.")],
