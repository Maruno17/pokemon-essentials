...
module Events
  ...
  # Triggers whenever a wild Pokemon is created
  # Parameters:
  # e[0] - Pokemon being created
  ...
  # Triggers whenever a wild Pokemon battle ends
  # Parameters:
  # e[0] - Pokemon species
  # e[1] - Pokemon level
  ...
  # Triggers whenever an NPC trainer's Pokemon party is loaded
  # Parameters:
  # e[0] - Trainer
